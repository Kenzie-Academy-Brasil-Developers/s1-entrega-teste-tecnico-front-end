...
const Inputs = ({setResultData}) =>{
    ...
    function errorApi() {
        ...
        axios.post("https://frontend-challenge-7bu3nxh76a-uc.a.run.app?internalError")
         .then((response) => {
	...
	function calculate(data) {
            setBoolean(true)
           axios.post("https://frontend-challenge-7bu3nxh76a-uc.a.run.app?delay=3000", data)
			.then((response) => {
    ...
    return(
        <form onSubmit={handleSubmit(calculate)} className="card-input">
            ...
            <div className="container-button">
                {boolean === false ? <button className="button-enviar" type="submit">Enviar</button> : <button disabled className="button-enviar">...Enviar</button>}
